...
int main(int argc,char **args)
{
   ...
   PetscErrorCode ierr;
   PetscInt       i,m = 101,n = 100000,l = 1,col[3],rstart,rend,nlocal,rank,its;
   PetscScalar    zero = 0.0,T = 1.0,k = 1.0,value[3],ui,fi;
   PetscReal      time,delta_x = 0.01,delta_t = T/n,r=k*delta_t/(delta_x*delta_x);
