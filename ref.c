...
int main(int argc,char **argv)
{
  ...
  PetscReal      dt,ftime,time_total_max = 1.0;   /* default max total time */
  PetscInt       steps,m,time_steps_max = 100;   /* default max timesteps */
  ...
  */
  ...
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
     ...
     - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
  PetscCall(PetscPrintf(PETSC_COMM_WORLD,"Total timesteps %D, Final time %g\n",steps,(double)ftime));
